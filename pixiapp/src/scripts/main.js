...
window.onload = function() {
  ...
  let DesktopHtmlContent = '<div id="main-inner-choice" style="display: block;font-family: \'Roboto\'; font-weight: 300;"><button type="button" class="start-action-button" id="start-btn" style="display: none;">Start</button></div>';
  //
