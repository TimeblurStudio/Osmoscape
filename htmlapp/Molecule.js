Molecule = function(x,y, buff, bufNum){
    ...
    this.render = function(pg){
        ...
        //pg.noFill();
        this.HAtom2.render(pg, this.PlayeProperties[this.propertiesIndex][1]);
        //pg.noFill();
        this.HAtom1.render(pg, this.PlayeProperties[this.propertiesIndex][0]);
    ...
    this.clicked = function(event){
        ...
        if(this.innerRadius<d && d<this.radius){
            ...
            if(this.propertiesIndex==this.PlayeProperties.length)this.propertiesIndex=0;
            this.calcProps();
        }
        else{
            for(var i=0; i<this.atoms.length;i++)
